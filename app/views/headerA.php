...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <!-- Nav Item - Dashboard -->
            <li class="nav-item">
                <a class="nav-link" href="/accueilG">
            ...
            <!-- Nav Item - Annonces (déjà existant) -->
            <li class="nav-item">
            ...
            <!-- Nav Item - Liste CV (déjà existant) -->
            <li class="nav-item">
            ...
            <!-- Nav Item - RH / Migration (déjà existant) -->
            <li class="nav-item">
            ...
            <!-- Nouveau : Planning Entretien -->
            <li class="nav-item">
                <a class="nav-link" href="/planning-entretien">
                    <i class="fas fa-calendar"></i>
                    <span>Planning Entretien</span>
                </a>
            </li>
            <!-- Divider -->
                        ...
                        <li class="nav-item dropdown no-arrow mx-1">
                            ...
                            <div class="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="messagesDropdown">
                                <h6 class="dropdown-header d-flex justify-content-between align-items-center">
                                    ...
                                    <input type="text" id="messageCenterSearch" class="form-control form-control-sm d-none" placeholder="Rechercher..." style="width: 150px;">
        ...
        <div class="small text-gray-500"><?= htmlspecialchars($msg['nom']) ?> <?= htmlspecialchars($msg['prenom']) ?></div>
                        ...
                        <li class="nav-item dropdown no-arrow">
                            ...
                            <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="userDropdown">
                                <a class="dropdown-item" href="/deconnexionA" data-toggle="modal" data-target="#logoutModal">
