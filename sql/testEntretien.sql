...
CREATE TABLE historique_planning_entretien (
  id_historique_planning INT GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
  id_entretien INT,
  etat INT,
  date_modification TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
  CONSTRAINT fk_entretien FOREIGN KEY (id_entretien) REFERENCES planning_entretien(id_entretien),
  CONSTRAINT fk_etat FOREIGN KEY (etat) REFERENCES etat(id_etat)
);
