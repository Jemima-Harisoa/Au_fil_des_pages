...
ALTER TABLE planning_entretien ADD FOREIGN KEY (id_responsable) REFERENCES responsable_entretien(id_responsable);
...
ALTER TABLE disponibilite_entretien ADD FOREIGN KEY (id_admin) REFERENCES admins(id_admin);
ALTER TABLE historique_disponibilite_entretien ADD FOREIGN KEY (id_dispo) REFERENCES disponibilite_entretien(id_dispo);
