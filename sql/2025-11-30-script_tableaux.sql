...
-- =========================
-- Performance module (evaluations)
-- =========================

CREATE TABLE IF NOT EXISTS employe_evaluation_periodes (
...
CREATE TABLE IF NOT EXISTS employe_criteres_evaluation (
...
DROP TRIGGER IF EXISTS employe_trg_evaluations_updated ON employe_evaluations;
...
CREATE TABLE IF NOT EXISTS employe_evaluations_details (
...
DROP TRIGGER IF EXISTS employe_trg_update_score ON employe_evaluations_details;
...
CREATE TABLE IF NOT EXISTS employe_performance_aggregations (
...
-- Some tables like "notifications" or "message_automatique" were duplicated in original script:
-- we kept single definitions earlier.
