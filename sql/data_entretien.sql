...
-- Vendeurs (annonce 1)
(1, 1, 75.50, '2025-10-19'),  -- Alice (id_candidat = 1) — aujourd’hui
(2, 1, 62.00, '2025-10-19'),  -- Bob (2)
(3, 1, 88.00, '2025-10-20'),  -- Caroline (3)
(4, 1, 55.25, '2025-10-20'),  -- David (4)
(13, 1, 92.50, '2025-10-21'), -- Mireille (13)
(14, 1, 68.00, '2025-10-21'), -- Nicolas (14)
(17, 1, 70.00, '2025-10-22'), -- Quentin (17)
(18, 1, 65.50, '2025-10-22'), -- Rita (18)

-- Caissiers (annonce 2)
(5, 2, 80.00, '2025-10-23'),  -- Evelyne (5)
(6, 2, 74.25, '2025-10-23'),  -- Fabrice (6)
(15, 2, 69.50, '2025-10-24'), -- Olivia (15)

-- Magasiniers (annonce 3)
(7, 3, 78.00, '2025-10-24'),  -- Gina (7)
(8, 3, 60.50, '2025-10-25'),  -- Hery (8)
(16, 3, 85.00, '2025-10-25'), -- Patrick (16)

-- Comptables (annonce 4)
(9, 4, 90.00, '2025-10-26'),  -- Isabelle (9)
(10, 4, 72.50, '2025-10-26'), -- Jules (10)
(19, 4, 88.75, '2025-10-27'), -- Samuel (19)

-- Gérants (annonce 5)
(11, 5, 95.00, '2025-10-27'), -- Karen (11)
(12, 5, 85.50, '2025-10-28'), -- Leo (12)
(20, 5, 91.00, '2025-10-28'); -- Thérèse (20)
